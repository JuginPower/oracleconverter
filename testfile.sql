...
DROP TABLE IF EXISTS class_assessments;
...
CREATE TABLE  COUNTRIES
   (COUNTRY_ID INT, 
	...
	COUNTRY_NAME VARCHAR(70) DEFAULT "CNAME_NN" NOT NULL, 
	...
	LIFE_EXPECT_AT_BIRTH DOUBLE(6,2), 
	MEDIAN_AGE DOUBLE(6,2), 
	AIRPORTS INT, 
...
CREATE TABLE  LOCATIONS
   (LOCATION_ID INT,
    ...
    CITY VARCHAR(30) DEFAULT "LOC_CITY_NN" NOT NULL,
...
ALTER TABLE  COUNTRIES ADD CONSTRAINT COUNTR_REG_ID_FK1 FOREIGN KEY (REGION_ID) REFERENCES  REGIONS (REGION_ID);
CREATE INDEX CTRY_REG_IDX ON COUNTRIES (REGION_ID);

CREATE TABLE  CURRENCIES 
   (CURRENCY_CODE VARCHAR(7), 
	CURRENCY_NAME VARCHAR(40) DEFAULT "CURR_NN" NOT NULL, 
...
CREATE TABLE  LANGUAGES
   (LANGUAGE_ID INT, 
	LANGUAGE_NAME VARCHAR(50) DEFAULT "LANG_LANGNAME_NN" NOT NULL, 
...
CREATE TABLE  DEPARTMENTS
   (DEPARTMENT_ID INT,
    DEPARTMENT_NAME VARCHAR(30) DEFAULT "DEPT_NAME_NN" NOT NULL,
    MANAGER_ID INT,
    LOCATION_ID INT,
...
CREATE TABLE  JOBS
   (JOB_ID VARCHAR(10),
    JOB_TITLE VARCHAR(35) DEFAULT "JOB_TITLE_NN" NOT NULL,
    MIN_SALARY INT,
    MAX_SALARY INT,
...
CREATE TABLE  EMPLOYEES
   (EMPLOYEE_ID INT,
    ...
    LAST_NAME VARCHAR(25) DEFAULT "EMP_LAST_NAME_NN" NOT NULL,
    EMAIL VARCHAR(25) DEFAULT "EMP_EMAIL_NN" NOT NULL,
    PHONE_NUMBER VARCHAR(20),
    HIRE_DATE DATETIME DEFAULT "EMP_HIRE_DATE_NN" NOT NULL,
    JOB_ID VARCHAR(10) DEFAULT "EMP_JOB_NN" NOT NULL,
    SALARY DOUBLE(8,2),
...
CREATE TABLE  JOB_HISTORY
   (EMPLOYEE_ID INT DEFAULT "JHIST_EMPLOYEE_NN" NOT NULL,
    START_DATE DATETIME DEFAULT "JHIST_START_DATE_NN" NOT NULL,
    END_DATE DATETIME DEFAULT "JHIST_END_DATE_NN" NOT NULL,
    JOB_ID VARCHAR(10) DEFAULT "JHIST_JOB_NN" NOT NULL,
    DEPARTMENT_ID INT,
...
ALTER TABLE  DEPARTMENTSDEFAULT "DEPT_MGR_FK";
...
CREATE TABLE  GRADE_CHANGES 
   (CHANGE_DATE DATE, 
	...
	STU_ID INT, 
	FINAL_NUMERIC_GRADE DOUBLE(5,2)
   );
   
CREATE TABLE  ASSESSMENTS 
   (ASSESSMENT_ID INT, 
    DESCRIPTION VARCHAR(1000) DEFAULT "SA_DESCIPT_NN" NOT NULL, 
    GRADING_CRITERIA VARCHAR(100), 
     CONSTRAINT SA_ASSESS_PK PRIMARY KEY (ASSESSMENT_ID)
     );
    
CREATE TABLE  STUDENTS 
   (STU_ID INT, 
    FIRST_NAME VARCHAR(25) DEFAULT "SA_STU_FN_NN" NOT NULL, 
    LAST_NAME VARCHAR(40) DEFAULT "SA_STU_LN_NN" NOT NULL, 
...
CREATE TABLE  CLASSES 
   (CLASS_ID INT, 
    START_DATE DATETIME DEFAULT "SA_START_NN" NOT NULL, 
    PERIOD VARCHAR(20) DEFAULT "SA_PERIOD_NN" NOT NULL, 
    FREQUENCY VARCHAR(10) DEFAULT "SA_FREQ_NN" NOT NULL, 
    INSTR_ID INT DEFAULT "SA_INSTR_NN" NOT NULL, 
    COURSE_ID INT DEFAULT "SA_COUR_NN" NOT NULL, 
     CONSTRAINT SA_CLASS_PK PRIMARY KEY (CLASS_ID)
     );

CREATE TABLE  INSTRUCTORS 
   (INSTRUCTOR_ID INT, 
    FIRST_NAME VARCHAR(25) DEFAULT "SA_INSTR_FN_NN" NOT NULL, 
    LAST_NAME VARCHAR(40) DEFAULT "SA_INSTR_LN_NN" NOT NULL, 
...
CREATE TABLE  SECTIONS 
   (SECTION_CODE INT, 
    TITLE VARCHAR(40) DEFAULT "SA_SECT_TITLE_NN" NOT NULL, 
    CHAIR_PERSON INT, 
...
CREATE TABLE  COURSES 
   (COURSE_ID INT, 
    TITLE VARCHAR(50) DEFAULT "SA_COUR_TITLE_NN" NOT NULL, 
    DURATION INT DEFAULT "SA_DUR_NN" NOT NULL, 
    DURATION_MEASURE VARCHAR(10) DEFAULT "SA_DUR_MEAS_NN" NOT NULL, 
    DATE_FIRST_OFFERED DATETIME DEFAULT "SA_FIRST_NN" NOT NULL, 
    DATE_LAST_OFFERED DATE, 
    DELIVERY_TYPE VARCHAR(15) DEFAULT "SA_DELIV_NN" NOT NULL, 
    SECTION_CODE INT DEFAULT "SA_SECT_NN" NOT NULL, 
...
CREATE TABLE  ENROLLMENTS 
   (ENROLLMENT_DATE DATE, 
    ...
    STU_ID INT, 
    FINAL_NUMERIC_GRADE DOUBLE(5,2), 
    FINAL_LETTER_GRADE VARCHAR(20), 
    STATUS VARCHAR(10) DEFAULT "SA_STATUS_NN" NOT NULL, 
...
CREATE TABLE  CLASS_ASSESSMENTS 
   (CLASS_ASSESSMENT_ID INT, 
    DATE_TURNED_IN DATE, 
    NUMERIC_GRADE DOUBLE(5,2), 
    LETTER_GRADE VARCHAR(20), 
    COMMENTS VARCHAR(1000), 
    CLASS_ID INT DEFAULT "SA_CLASS_ID_NN" NOT NULL, 
    STU_ID INT DEFAULT "SA_STU_ID_NN" NOT NULL, 
    ASSESSMENT_ID INT DEFAULT "SA_ASSESS_ID_NN" NOT NULL, 
...
CREATE TABLE  F_CUSTOMERS
   (ID INT,
    FIRST_NAME VARCHAR(25) DEFAULT "F_CSR_FIRST_NAME_NN" NOT NULL,
    LAST_NAME VARCHAR(35) DEFAULT "F_CSR_LAST_NAME_NN" NOT NULL,
    ADDRESS VARCHAR(50) DEFAULT "F_CSRS_ADDRESS_NN" NOT NULL,
    CITY VARCHAR(30) DEFAULT "F_CSR_CITY_NN" NOT NULL,
    STATE VARCHAR(20) DEFAULT "F_CSR_STATE_NN" NOT NULL,
    ZIP INT DEFAULT "F_CSR_ZIP_NN" NOT NULL,
    PHONE_NUMBER VARCHAR(10) DEFAULT "F_CSR_PHONE_NUMB_NN" NOT NULL,
     CONSTRAINT F_CSR_ID_PK PRIMARY KEY (ID)
     );

CREATE TABLE  F_PROMOTIONAL_MENUS
   (CODE VARCHAR(3),
    NAME VARCHAR(30) DEFAULT "F_PMU_NAME_NN" NOT NULL,
    START_DATE DATETIME DEFAULT "F_PMU_START_DATE_NN" NOT NULL,
    END_DATE DATE,
...
CREATE TABLE  F_REGULAR_MENUS
   (CODE VARCHAR(3),
    TYPE VARCHAR(30) DEFAULT "F_RMU_TYPE_NN" NOT NULL,
    HOURS_SERVED VARCHAR(30) DEFAULT "F_RMU_HOURS_SERVED_NN" NOT NULL,
     CONSTRAINT F_RMU_CODE_PK PRIMARY KEY (CODE)
     );

CREATE TABLE  F_FOOD_ITEMS
   (FOOD_ITEM_NUMBER INT,
    DESCRIPTION VARCHAR(100) DEFAULT "F_FIM_DESC_NN" NOT NULL,
    PRICE DOUBLE(8,2) CONSTRAINT F_FIM_PRICE_NN NOT NULL,
...
CREATE TABLE  F_STAFFS
   (ID INT,
    FIRST_NAME VARCHAR(25) DEFAULT "F_STF_FIRST_NAME_NN" NOT NULL,
    LAST_NAME VARCHAR(35) DEFAULT "F_STF_LAST_NAME_NN" NOT NULL,
    BIRTHDATE DATETIME DEFAULT "F_STF_BIRTHDATE_NN" NOT NULL,
    SALARY DOUBLE(8,2) CONSTRAINT F_STF_SALARY_NN NOT NULL,
    OVERTIME_RATE DOUBLE(5,2),
    TRAINING VARCHAR(50),
    STAFF_TYPE VARCHAR(20) DEFAULT "F_STF_STAFF_TYPE_NN" NOT NULL,
    MANAGER_ID INT,
    MANAGER_BUDGET DOUBLE(8,2),
    MANAGER_TARGET DOUBLE(8,2),
     CONSTRAINT F_STF_ID_PK PRIMARY KEY (ID)
     );

CREATE TABLE  F_ORDERS
   (ORDER_NUMBER INT,
    ORDER_DATE DATETIME DEFAULT "F_ODR_ORDER_DATE_NN" NOT NULL,
    ORDER_TOTAL DOUBLE(8,2),
    CUST_ID INT DEFAULT "F_ODR_CUST_ID_NN" NOT NULL,
    STAFF_ID INT DEFAULT "F_ODR_STAFF_ID_NN" NOT NULL,
...
CREATE TABLE  F_ORDER_LINES
   (ORDER_NUMBER INT,
    FOOD_ITEM_NUMBER INT,
    QUANTITY INT DEFAULT "F_OLE_QUANTITY_NN" NOT NULL,
     CONSTRAINT F_OLE_PK PRIMARY KEY (ORDER_NUMBER, FOOD_ITEM_NUMBER)
     );

CREATE TABLE  F_SHIFTS
   (CODE INT,
    DESCRIPTION VARCHAR(100) DEFAULT "F_SFT_DESC_NN" NOT NULL,
...
CREATE TABLE  F_SHIFT_ASSIGNMENTS
   (CODE INT,
    ID INT,
    SHIFT_ASSIGN_DATE DATETIME DEFAULT "F_SAT_SHIFT_ASSIGN_DATE_NN" NOT NULL,
...
CREATE TABLE  D_CDS
   (CD_NUMBER INT,
    TITLE VARCHAR(50) DEFAULT "D_CDS_TITLE_NN" NOT NULL,
    PRODUCER VARCHAR(50) DEFAULT "D_CDS_PRODUCER_NN" NOT NULL,
    YEAR VARCHAR(4) DEFAULT "D_CDS_YEAR_NN" NOT NULL,
     CONSTRAINT D_CDS_CD_NUMBER_PK PRIMARY KEY (CD_NUMBER)
     );

CREATE TABLE  D_CLIENTS
   (CLIENT_NUMBER INT,
    FIRST_NAME VARCHAR(25) DEFAULT "D_CLT_FIST_NAME_NN" NOT NULL,
    LAST_NAME VARCHAR(30) DEFAULT "D_CLT_LAST_NAME_NN" NOT NULL,
    PHONE INT DEFAULT "D_CLT_PHONE_NN" NOT NULL,
    EMAIL VARCHAR(50),
...
CREATE TABLE  D_PACKAGES
   (CODE INT,
    LOW_RANGE INT DEFAULT "D_PKE_LOW_RANGE_NN" NOT NULL,
    HIGH_RANGE INT DEFAULT "D_PKE_HIGH_RANGE_NN" NOT NULL,
     CONSTRAINT D_PKE_CODE_PK PRIMARY KEY (CODE)
     );

CREATE TABLE  D_THEMES
   (CODE INT,
    DESCRIPTION VARCHAR(100) DEFAULT "D_TME_DESC_NN" NOT NULL,
     CONSTRAINT D_TME_CODE_PK PRIMARY KEY (CODE)
     );

CREATE TABLE  D_VENUES
   (ID INT,
    LOC_TYPE VARCHAR(30) DEFAULT "D_VNE_LOC_TYPE_NN" NOT NULL,
    ADDRESS VARCHAR(100) DEFAULT "D_VNE_ADDRESS_NN" NOT NULL,
    RENTAL_FEE VARCHAR(50) DEFAULT "D_VNE_RENTAL_FEE_NN" NOT NULL,
...
CREATE TABLE  D_EVENTS
   (ID INT,
    NAME VARCHAR(50) DEFAULT "D_EVE_NAME_NN" NOT NULL,
    EVENT_DATE DATETIME DEFAULT "D_EVE_EVENT_DATE_NN" NOT NULL,
    DESCRIPTION VARCHAR(50),
    COST DOUBLE(8,2) CONSTRAINT D_EVE_COST_NN NOT NULL,
    VENUE_ID INT DEFAULT "D_EVE_VENUE_ID_NN" NOT NULL,
    PACKAGE_CODE INT DEFAULT "D_EVE_PACKAGE_CODE_NN" NOT NULL,
    THEME_CODE INT DEFAULT "D_EVE_THEME_CODE_NN" NOT NULL,
    CLIENT_NUMBER INT DEFAULT "D_EVE_CLIENT_NUMBER_NN" NOT NULL,
     CONSTRAINT D_EVE_ID_PK PRIMARY KEY (ID)
     );

CREATE TABLE  D_PARTNERS
   (ID INT,
    FIRST_NAME VARCHAR(25) DEFAULT "D_PTR_FIRST_NAME_NN" NOT NULL,
    LAST_NAME VARCHAR(30) DEFAULT "D_PTR_LAST_NAME_NN" NOT NULL,
    EXPERTISE VARCHAR(25),
    SPECIALTY VARCHAR(25),
    AUTH_EXPENSE_AMT DOUBLE(8,2),
    MANAGER_ID INT,
    PARTNER_TYPE VARCHAR(25) DEFAULT "D_PTR_PARTNER_TYPE_NN" NOT NULL,
...
CREATE TABLE  D_JOB_ASSIGNMENTS
   (PARTNER_ID INT,
    EVENT_ID INT,
    JOB_DATE DATETIME DEFAULT "D_JAT_JOB_DATE_NN" NOT NULL,
    STATUS VARCHAR(50),
...
CREATE TABLE  D_TYPES
   (CODE INT,
    DESCRIPTION VARCHAR(50) DEFAULT "D_TPE_DESC_NN" NOT NULL,
     CONSTRAINT D_TPE_CODE_PK PRIMARY KEY (CODE)
     );

CREATE TABLE  D_SONGS
   (ID INT,
    TITLE VARCHAR(50) DEFAULT "D_SNG_TITLE_NN" NOT NULL,
    DURATION VARCHAR(20),
    ARTIST VARCHAR(20),
    TYPE_CODE INT DEFAULT "D_SNG_TYPE_CODE_NN" NOT NULL,
...
CREATE TABLE  D_TRACK_LISTINGS
   (SONG_ID INT,
    CD_NUMBER INT,
    TRACK INT DEFAULT "D_TLG_TRACK_NUMBER_NN" NOT NULL,
